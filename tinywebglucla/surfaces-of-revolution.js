...
Declare_Any_Class( "PKey",
{ populate: function(tex, leftGap, rightGap) {
  this.positions.push(
        //top
        vec3(0, 1, 15),vec3(3, 1, 15),vec3(0, 1, 9),vec3(3, 1, 9),
        //Left
        vec3(0, -1, 9),vec3(0, 0, 15),vec3(0, 1, 9),vec3(0, 1, 15),
        //Right
        vec3(3, -1, 9),vec3(3, -1, 15),vec3(3, 1, 9),vec3(3, 1, 15),

        //Front
        vec3(0,-1,15), vec3(3,-1,15), vec3(0,1,15), vec3(3,1,15),

        //back
        vec3(0,-1,9), vec3(3,-1,9), vec3(0,1,9), vec3(3,1,9),
  ...
  for (var i = 0; i < 6; i++) {
    this.texture_coords.push( vec2(0,0),   vec2(tex,0),   vec2(0,tex),   vec2(tex,tex)   );
  }
  //Middle back rectangle is always there (never a middle gap)
  this.positions.push(
        //top
        vec3(1, 1, 9),vec3(2, 1, 9),vec3(1, 1, 0),vec3(2, 1, 0),
        //Left
        vec3(1, -1, 0),vec3(1, -1, 9),vec3(1, 1, 0),vec3(1, 1, 9),
        //Right
        vec3(2, -1, 0),vec3(2, -1, 0),vec3(2, 1, 0),vec3(2, 1, 0),
        //Front
        vec3(1,-1,9), vec3(2,-1,9), vec3(1,1,9), vec3(2,1,9),
        //back
        vec3(1,-1,0), vec3(2,-1,0), vec3(1,1,0), vec3(2,1,0),
        // Bottom
        vec3(1, -1, 9),vec3(2, -1, 9),vec3(1, -1, 0),vec3(2, -1, 0));
  ...
  if (!leftGap) {
    this.positions.push(
          //top
          vec3(0, 1, 9),vec3(1, 1, 9),vec3(0, 1, 0),vec3(1, 1, 0),
          //Left
          vec3(0, -1, 0),vec3(0, -1, 9),vec3(0, 1, 0),vec3(0, 1, 9),
          //Right
          vec3(1, -1, 0),vec3(1, -1, 0),vec3(1, 1, 0),vec3(1, 1, 0),
          //Front
          vec3(0,-1,9), vec3(1,-1,9), vec3(0,1,9), vec3(1,1,9),
          //back
          vec3(0,-1,0), vec3(1,-1,0), vec3(0,1,0), vec3(1,1,0),
          // Bottom
          vec3(0, -1, 9),vec3(1, -1, 9),vec3(0, -1, 0),vec3(1, -1, 0));
    ...
    for (var i = 0; i < 6; i++) {
      this.indices.push(index,index+1,index+2,index+1,index+3,index+2);
      index = index + 4;
      this.texture_coords.push( vec2(0,0),   vec2(tex,0),   vec2(0,tex),   vec2(tex,tex)   );
    }
  }
  ...
  if (!rightGap) {
    this.positions.push(
          //top
          vec3(2, 1, 9),vec3(3, 1, 9),vec3(2, 1, 0),vec3(3, 1, 0),
          //Left
          vec3(2, -1, 0),vec3(2, -1, 9),vec3(2, 1, 0),vec3(2, 1, 9),
          //Right
          vec3(3, -1, 0),vec3(3, -1, 0),vec3(3, 1, 0),vec3(3, 1, 0),
          //Front
          vec3(2,-1,9), vec3(3,-1,9), vec3(2,1,9), vec3(3,1,9),
          //back
          vec3(2,-1,0), vec3(3,-1,0), vec3(2,1,0), vec3(3,1,0),
          // Bottom
          vec3(2, -1, 9),vec3(3, -1, 9),vec3(2, -1, 0),vec3(3, -1, 0));
...
Declare_Any_Class( "PKey_Black",
  { populate: function(tex, leftGap, rightGap) {
    this.positions.push(
          //top
          vec3(-1, 2, 9),vec3(1, 2, 9),vec3(-1, 2, 0),vec3(1, 2, 0),
          //Left
          vec3(-1, -1, 0),vec3(-1, -1, 9),vec3(-1, 2, 0),vec3(-1, 2, 9),
          //Right
          vec3(1, -1, 0),vec3(1, -1, 0),vec3(1, 2, 0),vec3(1, 2, 0),
          //Front
          vec3(-1,-1,9), vec3(1,-1,9), vec3(-1,2,9), vec3(1,2,9),
          //back
          vec3(-1,-1,0), vec3(1,-1,0), vec3(-1,2,0), vec3(1,2,0),
          // Bottom
          vec3(-1, -1, 9),vec3(1, -1, 9),vec3(-1, -1, 0),vec3(1, -1, 0));
    this.normals.push(
      //top
      vec3(0, 1, 0),vec3(0, 1, 0),vec3(0, 1, 0),vec3(0, 1, 0),
      //Left
